...
./ysqlsh "host=2f388006-7501-4cce-86a4-d602844ea4e2.aws.ybdb.io \
user=admin \
dbname=yugabyte \
sslmode=verify-full \
sslrootcert=/Users/wierdvanderhaar/root.crt"

// You can find DB clients under the "bin" directory

Default Queries:
create database wh_demo;
\c wh_demo
...
wh_demo=> select distinct table_schema from information_schema.tables;
    table_schema    
--------------------
 information_schema
 pg_catalog
...
wh_demo=> select distinct table_catalog from information_schema.tables;
 table_catalog 
---------------
 wh_demo
(1 row)
...
-- Insert data 
INSERT INTO products (id, category, created_at, ean, price, rating, title, vendor) VALUES (1,'Gizmo','2017-07-19T19:44:56.582Z',1018947080336,29.463261130679875,4.6,'Rustic Paper Wallet','Swaniawski, Casper and Hilll');
...
INSERT INTO orders(id,created_at,discount,product_id,quantity,subtotal,tax,total,user_id) VALUES (9,'2017-05-03T16:00:54.923Z',3.594742155259162,184,3,77.3982748679465,4.26,81.6742695904106,1);
...
INSERT INTO reviews(id,body,created_at,product_id,rating,reviewer) VALUES (1,'Ad perspiciatis quis et consectetur. Laboriosam fuga voluptas ut et modi ipsum. Odio et eum numquam eos nisi. Assumenda aut magnam libero maiores nobis vel beatae officia.','2018-05-15T20:25:48.517Z',1,5,'christ');
