...
col disk_path format a40 heading "Disk Path"
col total_mb format 999,999 heading "MB"
col avg_read_ms format 999.99 heading "Avg Read|(ms)"
col io_reads_1k format  999,999 heading "IO Reads|/1000"
col io_writes_1k format  999,999 heading "IO Writes|/1000"
col io_1k format  999,999 heading "IO|/1000"
col io_secs format  9,999,999 heading "IO|seconds"
...
SELECT d.PATH disk_path, d.total_mb,
	   ...
	   ds.reads/1000 io_reads_1k,
	   ds.writes/1000 io_writes_1k,
